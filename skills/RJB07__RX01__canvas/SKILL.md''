...
Display HTML content on connected RX01 nodes (Mac app, iOS, Android).
...
```
http://<tailscale-hostname>:18793/__rx01__/canvas/<file>.html
```
...
Place files in the canvas root directory (default `~/rx01/canvas/`):

```bash
cat > ~/rx01/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
```bash
cat ~/.rx01/rx01.json | jq '.gateway.bind'
```

Then construct the URL:

- **loopback**: `http://127.0.0.1:18793/__rx01__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__rx01__/canvas/<file>.html`
...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__rx01__/canvas/snake.html
```
...
1. Check server bind: `cat ~/.rx01/rx01.json | jq '.gateway.bind'`
2. Check what port canvas is on: `lsof -i :18793`
3. Test URL directly: `curl http://<hostname>:18793/__rx01__/canvas/<file>.html`
...
Node is offline. Use `rx01 nodes list` to find online nodes.
...
The canvas host serves from `/__rx01__/canvas/` prefix:

```
http://<host>:18793/__rx01__/canvas/index.html  → ~/rx01/canvas/index.html
http://<host>:18793/__rx01__/canvas/games/snake.html → ~/rx01/canvas/games/snake.html
```

The `/__rx01__/canvas/` prefix is defined by `CANVAS_HOST_PATH` constant.
