...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.rx01/rx01.json`
...
- The script prints a `MEDIA:` line for RX01 to auto-attach on supported chat providers.
