-- ==============================================================================
-- 🏮 TOKCER AI: MIGRASI UTAMA DATABASE PRODUCTION (iogxyohoexfkpugdtymu)
-- ==============================================================================

-- ------------------------------------------------------------------------------
-- BLOK 1: FUNGSI PENYIAPAN PROFIL MODULAR (rpc_setup_client_account)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- BLOK 2: MESIN AKTIVASI LIFETIME (rpc_activate_account)
-- ------------------------------------------------------------------------------
...
BEGIN
    ...
    -- JIKA STARTER, SET EXPIRES_AT = NULL (LIFETIME)
    v_expires_at := CASE 
    ...
    -- Auth User Management (Idempotent)
...
-- ------------------------------------------------------------------------------
-- BLOK 3: PERBAIKAN SISTEM CRON HARIAN (rpc_daily_subscription_check)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- BLOK 4: RELOAD SKEMA CACHE SUPABASE INSTAN
-- ------------------------------------------------------------------------------
