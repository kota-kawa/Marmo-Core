...
- cleaned light curve and flux_err are available
- a sensible search range can be defined

## Candidate Postconditions
- a validated primary transit candidate is chosen for final writeout

## Candidate Failure Modes
- omitting flux_err
- choosing a half-period or double-period alias without checking
- returning a weak or nontransit candidate

## Candidate Evaluator Hooks
- candidate significance check
- alias review around period/2 and period*2
- final-value tolerance check against the reference period

## Bundle Interaction Note
- this is the primary detection method for final period selection
