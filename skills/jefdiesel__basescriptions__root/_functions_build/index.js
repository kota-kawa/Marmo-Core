...
// [[path]].js
var API_BASE = "https://basescriptions-api.wrapit.workers.dev";
async function onRequest(context) {
  ...
  if (path.startsWith("/register") || path.startsWith("/upload") || path.startsWith("/inscribe") || path === "/") {
    return context.next();
  }
...
// ../../.wrangler/tmp/pages-ghsWZG/functionsRoutes-0.6791452155719581.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",
