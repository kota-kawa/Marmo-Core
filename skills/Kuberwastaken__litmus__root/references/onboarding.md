...
> Every 3d  Archive   cleanup old attempts + multi-day research checkpoint
> ```
...
> - Longer archive window (less churn): archive every 7d instead of 3d
>
> **Agents & compute**
...
The script prints 7 cron job definitions. Run each `cron action:"add"` call.
