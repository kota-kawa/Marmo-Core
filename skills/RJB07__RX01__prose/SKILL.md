...
metadata: { "rx01": { "emoji": "🪶", "homepage": "https://www.prose.md" } }
---
...
## RX01 Runtime Mapping

- **Task tool** in the upstream spec == RX01 `sessions_spawn`
- **File I/O** == RX01 `read`/`write`
- **Remote fetch** == RX01 `web_fetch` (or `exec` with curl when POST is required)
