...
- time, flux, quality, and error columns are loaded correctly
- quality-flag convention is checked before filtering

## Candidate Postconditions
- cleaned data still preserves transit-like dips for later search

## Candidate Failure Modes
- reversing quality-flag semantics
- flattening away the transit signal
- introducing aliasing through overaggressive cleaning

## Candidate Evaluator Hooks
- preprocessing sanity plots or summary checks on retained data
- audit that flux_err survives into the search stage

## Bundle Interaction Note
- this stage should help transit search, not win cosmetic smoothness contests
