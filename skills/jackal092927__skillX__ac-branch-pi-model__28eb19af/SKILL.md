...
- parsed branch data, bus mappings, and per-unit state variables exist

## Candidate Postconditions
- branch flows, loadings, and nodal-balance terms are internally consistent

## Candidate Failure Modes
- wrong tap or phase-shift handling
- sign errors in P/Q flow equations
- inconsistent MVA-limit computation

## Candidate Evaluator Hooks
- bidirectional branch-flow recomputation
- loading percentage sanity check
- nodal-balance consistency check

## Bundle Interaction Note
- this stage encodes the physics layer the optimizer relies on
