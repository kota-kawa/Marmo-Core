...
$templatePromptPath = Join-Path (Join-Path $resolvedRoot 'templates') 'image-prompts.md.template'
...
foreach ($article in $articleTargets) {
    ...
    $bodyVisualPath = Join-Path (Join-Path $articleRoot 'assets') 'body-visual.png'
